 ...
 */
class Embed_Controller extends Template_Controller {
	/**
	...
	public function __construct()
	{
        ...
        // Load Header & Footer
		$this->template->header  = new View('embed/header');
		$this->template->footer  = new View('embed/footer');
    ...
    public function index()
    {
        ...
        $this->template->content = new View('embed/layout');
